...
public class ConcurrencyControlTest {
	...
	ConcurrencyControlTest(String fileName, Class<?> ccImpl, PrintStream out)
	...
	public static void main(String[] args) throws Exception {
		new ConcurrencyControlTest("schedule1.txt", concurrency.control.TimestampConcurrencyController.class, System.out);
		new ConcurrencyControlTest("schedule2.txt", concurrency.control.TimestampConcurrencyController.class, System.out);
		new ConcurrencyControlTest("schedule3.txt", concurrency.control.TimestampConcurrencyController.class, System.out);
		new ConcurrencyControlTest("schedule3.txt", concurrency.control.TimestampConcurrencyControllerTWR.class, System.out);
		new ConcurrencyControlTest("schedule1.txt", concurrency.control.Strict2PLConcurrencyController.class, System.out);
		new ConcurrencyControlTest("schedule2.txt", concurrency.control.Strict2PLConcurrencyController.class, System.out);
		new ConcurrencyControlTest("schedule3.txt", concurrency.control.Strict2PLConcurrencyController.class, System.out);
	}
